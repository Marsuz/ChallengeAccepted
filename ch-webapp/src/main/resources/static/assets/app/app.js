        ...
        .state('register', {
            ...
            controller: function ($scope, AuthService) {
                ...
                $scope.signUp = function () {
                    console.log( $scope.credentials);
                    AuthService.logIn({username : $scope.credentials.username, name: $scope.credentials.name, surname: $scope.credentials.surname, password: $scope.credentials.password})
                }
            }
        });
